  ...
  useEffect(() => {
    const loadPhotos = async () => {
      if (viewingTicket && viewingTicket.id) {
        ...
        // Salvar prazo original quando abre o modal
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          console.log('🔄 DEBUG - Mudando responsável de', viewingTicket.responsible, 'para', value);
                          setViewingTicket({ ...viewingTicket, responsible: value as 'Condomínio' | 'Construtora' });
                        }}
                      >
