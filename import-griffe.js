...
if (!supabaseUrl || !supabaseKey) {
  ...
  console.log('Certifique-se de que .env.local existe com NEXT_PUBLIC_SUPABASE_URL e NEXT_PUBLIC_SUPABASE_ANON_KEY');
  process.exit(1);
}
...
async function importGriffe() {
  console.log('📂 Lendo planilha do Griffe...');

  // Ler planilha
  const workbook = XLSX.readFile(path.join(__dirname, 'para ler', 'Griffe.xlsx'));
...
importGriffe().catch(console.error);
